...
void lossy_coding::golombDesc(Mat &DescY, Mat &DescV, Mat &DescU,int m,char* namefile){
 ...
 /*
void lossy_coding::golombDesc(Mat prevY, Mat prevV, Mat prevU, Mat erroY, Mat erroV, Mat erroU, Mat &DescY, Mat &DescV, Mat &DescU){
    //ler de um ficheiro 
...
/*
    ...
    lossy.golombEnc(erroY,erroV,erroU,m,outfile); //da nos o erro para a funcao ValorPixelDec
   ...
   */
    ...
    //int lossy_coding::ValorPixelDec (int erro, int valorPrevisto){
...
//int lossy_coding::ValorPixelDec (int erro, int valorPrevisto){ erro = golomb -> valor previsto = preditor
